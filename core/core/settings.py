...
IDEA_EXPIRY_HOURS = int(os.getenv('IDEA_EXPIRY_HOURS', '80'))
...
YOUTUBE_RESEARCH_CACHE_SECONDS = int(
    os.getenv('YOUTUBE_RESEARCH_CACHE_SECONDS', '21600')
)
YOUTUBE_RESEARCH_HTTP_TIMEOUT_SECONDS = int(
    os.getenv('YOUTUBE_RESEARCH_HTTP_TIMEOUT_SECONDS', '10')
)
YOUTUBE_RESEARCH_LLM_TIMEOUT_SECONDS = int(
    os.getenv('YOUTUBE_RESEARCH_LLM_TIMEOUT_SECONDS', '25')
)
